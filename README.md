...
### Observations:
**Courts & Commissions**: As far as distribution goes, courts and commissions have the most natural spread, which makes sense given their priority is to create fair districts. The median of the commissions is between 6-8, but this makes sense given that states with commissions tend to be more democratic overall (CA, CO, MI, AZ, HI, ID, MO, NJ, WA)<br />
